  ...
  return (
    <div className="bg-base flex-1 min-h-screen p-14 flex flex-col gap-9 items-start">
      ...
      <div className="flex flex-col gap-4">
        ...
        <button className="btn btn-active btn-primary btn-xl px-18 " onClick={() => signUpModal.openModal()}>
          Sign up
        </button>
        <SignUpModal {...signUpModal} />
        <div className="text-2xl font-bold">Already have an account ?</div>
        <button className="btn btn-outline btn-primary btn-xl px-18" onClick={() => signInModal.openModal()}>
          Sign in
        </button>
